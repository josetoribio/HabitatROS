...
bool habitat_msgs__msg__habitat_sensor__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // humidity_percent
    PyObject * field = PyObject_GetAttrString(_pymsg, "humidity_percent");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->humidity_percent = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // sensor_id
...
{
  /* NOTE(esteve): Call constructor of HabitatSensor */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("habitat_msgs.msg._habitat_sensor");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "HabitatSensor");
  ...
  {  // humidity_percent
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->humidity_percent);
    {
      int rc = PyObject_SetAttrString(_pymessage, "humidity_percent", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
